...
bool IsOverlapPeriods(stDate Period1Start, stDate Period1End, stDate Period2Start, stDate Period2End)
{
    ...
    while (!IsDate1EqualDate2(Period1Start, Period1End))
    {
        if (((CompareDate(Period1Start, Period2Start) == enCompareDate::After) && (CompareDate(Period1End, Period2End) == enCompareDate::Before))
            || (IsDate1EqualDate2(Period1Start, Period2Start)) || (IsDate1EqualDate2(Period1Start, Period2End)) )
        {
            return true;
        }

        Period1Start = IncreaseDateByOneDay(Period1Start);
    }
